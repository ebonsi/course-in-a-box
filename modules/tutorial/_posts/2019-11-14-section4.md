...
Observe that the prepend ```$ORIGIN domain1.com.``` and ```$ORIGIN 1.168.192.in-addr.arpa.``` will allow me to represent the domain in question by a symbol "@". so @ means domain1.com. Things that you must observe in your reverse zone is how your ip is formed.

If for instance, you do not use the prepend clause, you will have to write your addresses in a full formal way; Example:
