...
#### Next, we are going back to Section 4, Bind Configuration. I will be putting a TTL Zone file example configuration there.

#### Therefore, head yourself to [Section 4](https://ebonsi.github.io/course-in-a-box/modules/tutorial/section4/)
