...
#### There is a Complete List of the Open Source Software on | Internet Society
#### Obs: You must become a member to access the material (It is a free membership).

#### [https://bit.ly/2kN44bm](https://bit.ly/2kN44bm){:target="_blank"}

### Obs: If you, for any reason could not sign in to Internet Society, I am advancing the Open Source Software plus some useful terminal commands I use on a daily basis for different tasks. You can find this list here in this page bellow number 3.
...
- #### Google Domain Host: [https://domains.google/](https://domains.google/){:target="_blank"}

- #### Name Domain Host: [https://www.name.com/](https://www.name.com/){:target="_blank"}
...
### If you for any reason could not sign in to Internet Society, I am advancing the Open Source Software plus some useful terminal commands I use on a daily basis for different tasks.

---

#### My number one software for network administration is Webmin. I think they also have a windows version.

#### 01.0. Webmin, [https://webmin.com/](https://webmin.com/){:target="_blank"}
...
#### 02.0. Common version: [https://www.mozilla.org/en-US/firefox/new/](https://www.mozilla.org/en-US/firefox/new/){:target="_blank"}

#### 02.1. Developer's version: [https://www.mozilla.org/en-US/firefox/developer/](https://www.mozilla.org/en-US/firefox/developer/){:target="_blank"}
...
#### 03.0. [https://www.torproject.org](https://www.torproject.org){:target="_blank"}
...
#### 04.0. [https://www.isc.org/bind/](https://www.isc.org/bind/){:target="_blank"}
...
#### 05.0. [https://httpd.apache.org/](https://httpd.apache.org/){:target="_blank"}
...
#### 06.0. [https://bitnami.com/stacks](https://bitnami.com/stacks){:target="_blank"}
...
#### 06.1. [https://sequelpro.com/](https://sequelpro.com/){:target="_blank"}
...
#### 07.0. [https://letsencrypt.org](https://letsencrypt.org){:target="_blank"}

#### 07.1 [https://www.eff.org/](https://www.eff.org/){:target="_blank"}
...
#### 08.0. [https://www.opencart.com/](https://www.opencart.com/){:target="_blank"}
...
#### 09.0. [https://www.libreoffice.org/](https://www.libreoffice.org/){:target="_blank"}

#### 09.1. [https://www.openoffice.org/](https://www.openoffice.org/){:target="_blank"}
...
#### 10.0. [https://www.wireshark.org](https://www.wireshark.org){:target="_blank"}
...
#### [http://rdns6.com/hostRecord](http://rdns6.com/hostRecord){:target="_blank"}

#### For designing websites, I found this online editor to be great. If you know the code you can do anything.

#### [https://grapedrop.com/](https://grapedrop.com/){:target="_blank"}
